...
if (isset($_GET['id'])){
  ...
  $paysc1=new PaysC();
    $result=$paysc1->recupererpays($_GET['id']);
...
<div class="form-group">
<input  type="hidden" name="id_ai" value="<?PHP echo $_GET['id'];?>">
</div>
</table>
</div>
...
if (isset($_POST['modifier'])){
  ...
  $pays=new Pays($_POST['Id'],$_POST['Nom'],$_POST['Image']);
  $paysc1->modifierpays($pays,$_POST['id_ai']);
  //echo $_POST['id_ini'];
  echo "sahiiiit ";

  echo ("<script> window.location.replace(\"Pays.php\")</script>");
}
