...
if (isset($_GET['id'])){
    ...
    $result=$produitc1->recupererproduit($_GET['id']);
...
<input class="form-control" required pattern="[0-9a-zA-Z-\.]{3,12}" placeholder="Entre the name of product" type="text" name="Nom" value="<?PHP echo $Nom ?>">
</div>

<div class="form-group">
<input class="form-control" required pattern="[0-9.]{1,12}" placeholder="Enter your Price" type="number" name="Prix" value="<?PHP echo $Prix ?>">
</div>
...
<div class="form-group">
<input class="form-control" required pattern="[0-9]{1,5}" placeholder="Enter your Quantite" type="number" name="Quantite" value="<?PHP echo $Quantite ?>">
</div>

<div class="form-group">
<textarea class="form-control" required pattern="[0-9a-zA-Z-\.]{3,12}" placeholder="Informations About the products" name="Description" value="<?PHP echo $Description ?>"></textarea>
</div>
...
if (isset($_POST['modifier'])){
	...
	$produit=new Produit($Id,$_POST['Nom'],$_POST['Prix'],$_POST['Image'],$_POST['Quantite'],$_POST['Description'],$_POST['Idcat']);
	$produitc1->modifierproduit($produit,$_POST['id_ini']);
	echo $_POST['id_ini'];
