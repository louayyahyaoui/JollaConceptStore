...
<input type="text" name="Nom" class="form-control" required pattern="[0-9a-zA-Z-  \.]{3,12}" placeholder="Entre the name of Categorie">
</div>                  
<div class="form-group">
...
$categorie2c=new CategorieC();
$listeCategorie=$categorie2c->afficherCategories();
			...
			<thead >
			  <tr >
               ...
               <tr>
                  ...
                  <td  style="width: 10%" class="width="70% ><form method="POST" action="supprimerCategorie.php">
                  <input type="submit" name="supprimer" value="supprimer"  class="btn btn-danger btn-block" >
                  <input type="hidden" value="<?PHP echo $row['Id']; ?>" name="Id">
                  </form>
                  </td>
                  <td style="width: 10%"><a class="btn btn-success btn-block" href="modifierCategorie.php?id=<?PHP echo $row['Id']; ?>">
	Modifier</a></td>
	</tr>
