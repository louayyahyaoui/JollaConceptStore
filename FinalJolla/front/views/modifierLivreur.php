...
<br><br><br>
 ...
 CIN: <input type="number" name="Cin" value="<?PHP echo $Cin ?>">
  ...
  <br><br>
   Telephone: <input type="tel" name="Telephone" value="<?PHP echo $Telephone?>">
...
<a href="check_afficherlivreur01.php?ID=<?PHP echo $row['idliv']; ?>">Return</a>
...
if (isset($_POST['modifier'])){
  ...
  echo $_POST['cin_ini'];
  echo "modifie";
  // header('Location: check_afficherlivreur01.php');
}
