...
$panierC=new panierC();
$listeproduit=$panierC->recupererpanier($_SESSION["idclient"]);
...
foreach($listeproduit as $row){
	...
	<input type="hidden" value="<?PHP echo $row['idp']; ?>" name="id">
	</form>
	</td>
	<td>
	...
	<td>
		...
		<input type="number" name="quantitee" value="<?PHP echo $row['quantite']; ?>" min="1">
		
		</td>
		<td>
		
		
		<input type="hidden" name="q1" value="<?PHP echo $row['id']; ?>">
...
?>
	...
	<th>Total</th>
<?php 
$produit1=$panierC->recupererpanier($_SESSION["idclient"]);
$tab=array();
  $somme=0;
...
?>
	...
	<td><?PHP echo $somme ?></td>
		...
		<div class="checkout-left">	
				...
				<div> 
				<center>
				<form action="ajouterlignecommande.php">	
					<input type="submit" name="commande" value="commander" class="glyphicon glyphicon-menu-left">
