<?php
        ...
        $listeclients=$livreur1C->recupererClient($_SESSION["idclient"]);
...
<form method="POST" action="ajouterLivreur.php"> 
  ...
  <br><br>
    <input type="text" name="Nom" placeholder="Nom" value="<?PHP echo $row['FirstName']; ?>" >
  
  <br><br>
    <input type="text" name="Prenom"  placeholder="Prenom"  value="<?PHP echo $row['LastName']; ?>">
  ...
  <br><br>
 <input type="text" name="Gouvernerat" placeholder="Gouvernerat " >
  
  <br><br>
  <input type="email" name="Email"   placeholder="E-mail" value="<?PHP echo $row['Mail']; ?>"  >
...
<select name="Pays">
	<?PHP
	$listepays=$livreur1C->afficherpays();
foreach($listepays as $siwar){
	?>
	<option value="<?PHP echo $siwar['Nom']; ?>"><?PHP echo $siwar['Nom']; ?><br><br>
	</option>
	<?PHP }  ?>
</select> 
...
?>
   ...
   <input type="submit" name="submit" class="item_add single-item hvr-outline-out button2" value="Livrer">
