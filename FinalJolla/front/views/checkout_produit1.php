...
if(empty($_POST['search'])==false){
	$x=$_POST['search'];
		 $listeProduits=$produit1C->rechercherProduit($x);}
...
<div class=" container ">
                <form method="POST" action="checkout_produit1.php">
                    <input type="text" id="arearech" name="search" placeholder="Taper pour rechercher ... " required>

                    <input type="submit" value="Rechercher"  class="btn btn-primary">

					<a href="checkout_produit1.php" class="btn btn-primary">
...
<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem" > 
								...
								<img width="700" src="images/<?php echo $row['Image'] ?>" alt="<?php echo $row['Image'] ?>" class="pro-image-front">
								<img width="700" src="images/<?php echo $row['Image'] ?>"  alt="<?php echo $row['Image'] ?>" class="pro-image-back">
								<hr>
