<?PHP
           ...
           $listeLivraisons=$livraison1C->afficherLivraisons($_SESSION["idclient"]);
...
<div class="checkout">
  ...
  <td><a href="modifierLivraison.php?ID=<?PHP echo $row['IDlivraison']; ?>">
  Modifier</a></td>
  <td>
  <form method="POST" action="pdflivraison.php">
    <input type="submit" name="pdf" value="pdf">
  <input type="hidden" value="<?PHP echo $row['IDlivraison']; ?>" name="ID">
</form></td>

<td><a href="check_afficherlivreur01.php?ID=<?PHP echo $row['IDlivraison']; ?>">Livré à</a></td>
...
<div class="checkout-left"> 
        ...
        <div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
          <a href="index1.php"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Retour</a>
        </div>
        <div> 
